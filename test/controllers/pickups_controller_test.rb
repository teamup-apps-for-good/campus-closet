...
class PickupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pickup" do
    assert_difference("Pickup.count") do
      post pickups_url, params: { pickup: { donator_id: @pickup.donator_id, item_id: @pickup.item_id, receiver_id: @pickup.receiver_id } }
    end
  ...
  test "should update pickup" do
    patch pickup_url(@pickup), params: { pickup: { donator_id: @pickup.donator_id, item_id: @pickup.item_id, receiver_id: @pickup.receiver_id } }
