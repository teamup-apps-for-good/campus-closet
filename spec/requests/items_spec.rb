...
RSpec.describe '/items', type: :request do
  ...
  let(:valid_attributes) do
    { color: Color.create(name: 'temp_color'), type: Type.create(name: 'temp_type'),
      gender: Gender.create(name: 'temp_gender'), status: Status.create(name: 'temp_status'), size: Size.create(name: 'temp_size'), condition: Condition.create(name: 'temp_condition') }
