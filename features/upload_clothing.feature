...
Background: clothing in database
  ...
  | name       | color     | type       | Description   | Gender  | Size  | Condition      |
  | t-shirt-5  | black     | t-shirt    | t-shirt       | M       | M     |       |
  | pants-1    | red       | pants      | pants         | F       | L     |       |
  | sweater-7  | blue      | sweater    | sweater       | M       | S     |       |
  | belt-2     | brown     | belt       | belt          | F       | M     |       |
