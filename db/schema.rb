...
ActiveRecord::Schema[7.1].define(version: 2024_01_31_003807) do
  ...
  create_table "pickups", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["donator_id"], name: "index_pickups_on_donator_id"
  ...
  add_foreign_key "pickups", "donators"
  add_foreign_key "pickups", "items"
  add_foreign_key "pickups", "receivers"
  add_foreign_key "requests", "donators"
  add_foreign_key "requests", "items"
  add_foreign_key "requests", "receivers"
end
